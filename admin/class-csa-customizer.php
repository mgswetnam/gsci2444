 ...
 * @class GSCI_Customizer
 */

final class GSCI_Customizer {
  ...
  public function __construct() {
    // Actions
    add_action( "customize_register", array( $this, "gsci_customizer" ) );
    add_action( "customize_controls_enqueue_scripts", array( $this, "gsci_customizer_setup" ) );
    // Filters
  ...
  public static function gsci_customizer_setup(){
		// Scripts
    wp_enqueue_script( 'gsci-admin-customizer', FL_CHILD_THEME_URL . '/admin/assets/dist/js/customizer.min.js', array('jquery'), true );
  }

  public static function gsci_customizer( $wp_customize ){
